...
import { loadDrugs, registerPatient } from '../actions'
...
const loadData = ({ loadDrugs }) => {
    loadDrugs()
}



let PatientRegisterPage = class PatientRegisterPage extends Component {
    ...
    handleSubmit(data) {
        ...
        let patientRegisterPromise = this.props.registerPatient(data)
                        ...
                        <div className="row">
                            ...
                            <div className="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    <button className="btn btn-primary" type="submit" onClick={handleSubmit(this.handleSubmitWithDiagnose.bind(this))}>Save Patient & Diagnose</button>
                                    <button className="btn btn-white" type="submit" onClick={handleSubmit(this.handleSubmit.bind(this))}>Save Patient</button>
                                </div>
                            </div>
...
PatientRegisterPage = reduxForm({
    form: 'PatientRegisterPage',
    validate
})(PatientRegisterPage)

const mapStateToProps = (state, ownProps) => {
    const { drugs, auth } = state
...
PatientRegisterPage = connect(mapStateToProps, {
    loadDrugs,
    registerPatient
})(PatientRegisterPage)
